        ...
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                ...
                <ul class="navbar-list">
                    ...
                    <li class="navbar-item">
                        <a href="../Room.php" class="navbar-link active" style="display:flex;">Rooms->Room01</a>
                    </li>
                    <li class="navbar-item">
    ...
    <main>
        <article>
                ...
                <div class="container">
                    <div class="hero-content">
                        ...
                        <figure class="hero-banner mobile">
                            <iframe class="w-100" alt="" width="631" height="276" style="border-radius: 10px; box-shadow: 0 0 0 4px #00000033;"
                    ...
                    <figure class="hero-banner pc">
                        <iframe class="w-100" alt="" width="631" height="276"  style="border-radius: 10px; box-shadow: 0 0 0 4px #00000033;" src="https://momento360.com/e/u/6954667f00a34b518720eef09dfabfe5?utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of-view=75&size=medium&display-plan=true" frameborder="0"></iframe>
                    </figure>
                </div>
            </section>
            ...
            <section class="section imgmore" id="imagesMore">
                ...
                <p>🥰There are More Images to get a clear idea about our room number 01.🥰</p>
                <div class="img">
