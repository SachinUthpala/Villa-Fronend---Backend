    ...
    <main>
      <article>
        ...
        <section class="section rooms"
            style="background-image: url(../assets/images/hero-bg.jpg)">
            <div class="container">
                <h2 class="h3 title title-section room-title">
                    <span>Room 01</span>
                    <span class="availability">
                        Avilable
                    </span>
                </h2>
                <p class="section-text" style="display: flex; ">
                    Price (USD) - <span style="color: hsl(249, 95%, 63%);">150$/Day</span>
                </p><br>
                <p class="secondary-text" style="text-align: center;">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem aut expedita modi vero error. Officia ipsa,
                    dolore animi qui explicabo, et excepturi aperiam possimus repellat quae eaque aspernatur fuga at!
                </p>
            ...
            <div class="container">
                ...
                <br>
                <p class="secondary-text" style="text-align: center;">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem aut expedita modi vero error. Officia ipsa, dolore animi qui explicabo, et excepturi aperiam possimus repellat quae eaque aspernatur fuga at!
                </p>
                <br>
